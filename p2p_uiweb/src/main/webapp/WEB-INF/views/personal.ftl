						...
						<div class="panel-body el-account">
							<div class="el-account-info">
								...
								<div class="pull-left" style="text-align: center;width: 400px;margin:30px auto 0px auto;">
									<a class="btn btn-primary btn-lg" href="#" id="alipay">账户充值</a>
		...
		<div class="modal fade" id="alipayModal" tabindex="-1" role="dialog" aria-labelledby="alipayModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		        <h4 class="modal-title" id="alipayModalLabel">充值</h4>
		      </div>
		      <div class="modal-body">
		        <form class="form-horizontal" id="bindAlipayForm" method="post" action="/gotoAlipay.do">
		        	<div class="form-group">
					    <label for="alipay" class="col-sm-2 control-label">充值金额:</label>
					    <div class="col-sm-6">
		      ...
		      <div class="modal-footer">
		        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
		        <button type="button" class="btn btn-primary" id="bindAlipay">充值</button>
		      </div>
		    </div>
		  </div>
		</div>
